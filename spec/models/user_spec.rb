...
describe User do
  ...
  #we will do some refactoring here using the merge method...add the followind bloc method with @attr variable
  before(:each) do
    @attr = {
      :name => "Example User", 
  ...
  it "should create a new instance given a valid attribute" do
    ...
    User.create!(@attr)   #refactored code
  end
 ...
 describe "password valication" do
